...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_right_side = QtWidgets.QLabel(self.footer)
        self.lbl_right_side.setMinimumSize(QtCore.QSize(145, 34))
        self.lbl_right_side.setMaximumSize(QtCore.QSize(145, 34))
        self.lbl_right_side.setText("")
        self.lbl_right_side.setObjectName("lbl_right_side")
        self.horizontalLayout_4.addWidget(self.lbl_right_side)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_estado_juego.setProperty(
            "class", _translate("MainWindow", "h5 color-white")
        )
        self.btn_volver.setText(_translate("MainWindow", "Volver"))
        self.btn_volver.setProperty(
            "class", _translate("MainWindow", "btn btn-outline-dark h6")
        )
