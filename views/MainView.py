...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_saludo = QtWidgets.QLabel(self.frame_2)
        self.lbl_saludo.setMinimumSize(QtCore.QSize(310, 70))
        self.lbl_saludo.setMaximumSize(QtCore.QSize(350, 32))
        self.lbl_saludo.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
        self.lbl_saludo.setObjectName("lbl_saludo")
        self.verticalLayout_4.addWidget(self.lbl_saludo)
        self.lbl_dificultad = QtWidgets.QLabel(self.frame_2)
        self.lbl_dificultad.setMinimumSize(QtCore.QSize(310, 32))
        self.lbl_dificultad.setMaximumSize(QtCore.QSize(350, 32))
        self.lbl_dificultad.setObjectName("lbl_dificultad")
        self.verticalLayout_4.addWidget(self.lbl_dificultad)
        self.box_dificultad = QtWidgets.QComboBox(self.frame_2)
        self.box_dificultad.setMinimumSize(QtCore.QSize(310, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Yoshi's World"))
        self.centralwidget.setProperty(
            "class", _translate("MainWindow", "background-white")
        )
        self.lbl_titulo.setText(_translate("MainWindow", "Yoshi's World"))
        self.lbl_titulo.setProperty(
            "class", _translate("MainWindow", "h1 color-success")
        )
        self.lbl_saludo.setText(_translate("MainWindow", "Hola!"))
        self.lbl_saludo.setProperty("class", _translate("MainWindow", "h3"))
        self.lbl_dificultad.setText(
            _translate("MainWindow", "Selecciona la dificultad:")
        )
        ...
        self.btn_iniciar.setProperty(
            "class", _translate("MainWindow", "btn-success h6")
        )
        self.lbl_side_image.setProperty(
            "class", _translate("MainWindow", "background-light")
        )
        self.footer.setProperty("class", _translate("MainWindow", "background-success"))
        self.btn_sobre.setText(_translate("MainWindow", "Sobre"))
        self.btn_sobre.setProperty(
            "class", _translate("MainWindow", "btn-outline-dark")
        )
